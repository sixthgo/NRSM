...
namespace Eland.NRSM.Web.Controllers
{
    ...
    public class MaterialPriceInforApiController : ApiController
    {
        ...
        public MaterialInforDetail Get(string werks, string matnr, string x)
        {
            MaterialPriceInfo materialPrice = new MaterialPriceInfo();

            materialPrice.wERKS = werks;
            materialPrice.mATNR = matnr;

            var result = QueryMaterialPriceInfoService.GetMaterialInforDetail(materialPrice);
