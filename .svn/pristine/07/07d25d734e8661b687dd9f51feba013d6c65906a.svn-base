...
function $HttpProvider() {
  ...
  this.$get = ['$httpBackend', '$browser', '$cacheFactory', '$rootScope', '$q', '$injector',
     ...
     *
     * ## General usage
     * The `$http` service is a function which takes a single argument ??a configuration object ??     * that is used to generate an HTTP request and returns  a {@link ng.$q promise}
     ...
     * the `then` method to register callbacks, and these callbacks will receive a single argument ??     * an object representing the response. See the API signature and type info below for more
     * details.
     *
     ...
     *    - **transformRequest** ??     *      `{function(data, headersGetter)|Array.<function(data, headersGetter)>}` ??     *      transform function or an array of such functions. The transform function takes the http
     *      request body and headers and returns its transformed (typically serialized) version.
     *      See {@link #overriding-the-default-transformations-per-request Overriding the Default Transformations}
     *    - **transformResponse** ??     *      `{function(data, headersGetter)|Array.<function(data, headersGetter)>}` ??     *      transform function or an array of such functions. The transform function takes the http
...
function $SceProvider() {
  ...
  this.$get = ['$parse', '$sceDelegate', function(
     ...
     *
     * @description
     * Shorthand method.  `$sce.parseAsHtml(expression string)` ??     *     {@link ng.$sce#parseAs `$sce.parseAs($sce.HTML, value)`}
     *
     * @param {string} expression String expression to compile.
     * @returns {function(context, locals)} a function which represents the compiled expression:
     *
     ...
     *
     * @description
     * Shorthand method.  `$sce.parseAsCss(value)` ??     *     {@link ng.$sce#parseAs `$sce.parseAs($sce.CSS, value)`}
     *
     * @param {string} expression String expression to compile.
     * @returns {function(context, locals)} a function which represents the compiled expression:
     *
     ...
     *
     * @description
     * Shorthand method.  `$sce.parseAsUrl(value)` ??     *     {@link ng.$sce#parseAs `$sce.parseAs($sce.URL, value)`}
     *
     * @param {string} expression String expression to compile.
     * @returns {function(context, locals)} a function which represents the compiled expression:
     *
     ...
     *
     * @description
     * Shorthand method.  `$sce.parseAsResourceUrl(value)` ??     *     {@link ng.$sce#parseAs `$sce.parseAs($sce.RESOURCE_URL, value)`}
     *
     * @param {string} expression String expression to compile.
     * @returns {function(context, locals)} a function which represents the compiled expression:
     *
     ...
     *
     * @description
     * Shorthand method.  `$sce.parseAsJs(value)` ??     *     {@link ng.$sce#parseAs `$sce.parseAs($sce.JS, value)`}
     *
     * @param {string} expression String expression to compile.
     * @returns {function(context, locals)} a function which represents the compiled expression:
     *
